package oracle.input_output_streams.input_output_streams.data_streams;

import java.io.*;

public class DataStreams {

    private static final String DATA_FILE_NAME = "src/oracle/input_output_streams/input_output_streams/data_streams/data.txt";
