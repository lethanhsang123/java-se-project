package java_core.core_java_volume_1_12ed.chapter_12_concurrency.asynchronous_computations;
...
public class CompletableFutureDemoFinal {
...
HttpRequest request =
HttpRequest.newBuilder(urlToProcess.toURI()).GET()
.build();
...
*/
    ...
    public static void main(String[] args)
            throws IOException, InterruptedException {
        new CompletableFutureDemoFinal().run(new URL("http://horstmann.com/index.html"));
    }
}
